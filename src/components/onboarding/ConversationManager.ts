...
export const QUESTIONS: Question[] = [
  ...
  {
    id: 'workoutTypes',
    botMessage: "Nice schedule! Now pick the muscle groups you want to train - you can combine them however you like!",
    componentType: 'options',
    multiSelect: true,
    required: true,
    options: [
      { id: 'chest', label: 'Chest', icon: 'Dumbbell', description: 'Pecs, push movements' },
      { id: 'back', label: 'Back', icon: 'User', description: 'Lats, rows, pulls' },
      { id: 'shoulders', label: 'Shoulders', icon: 'Target', description: 'Delts, presses' },
      { id: 'arms', label: 'Arms', icon: 'Zap', description: 'Biceps & Triceps' },
      { id: 'legs', label: 'Legs', icon: 'Move', description: 'Quads, hamstrings, glutes' },
