...
export default function ExerciseDetailsModal({ exercise, isOpen, onClose }: ExerciseDetailsModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <AnimatePresence>
        {isOpen && (
          <DialogContent className="glass-card border-white/10 text-white max-w-md mx-auto p-0 overflow-hidden" asChild>
            <motion.div
            ...
            >
              ...
              <div className="p-5 space-y-4">
                ...
                <button
                  onClick={onClose}
                  className="w-full bg-gradient-to-r from-[#7c57ff] to-[#60a5fa] text-white py-3 rounded-xl font-semibold btn-glow transition-all"
