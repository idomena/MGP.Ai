...
const WORKOUT_TYPES = [
  ...
  { type: "chest_shoulders", title: "Chest + Shoulders", icon: Dumbbell, color: "from-blue-500 to-orange-500" },
  { type: "back_arms", title: "Back + Arms", icon: Activity, color: "from-green-500 to-cyan-500" },
  { type: "chest_back", title: "Chest + Back", icon: Dumbbell, color: "from-blue-500 to-green-500" },
  { type: "shoulders_arms", title: "Shoulders + Arms", icon: Zap, color: "from-orange-500 to-cyan-500" },
  { type: "legs_core", title: "Legs + Core", icon: Activity, color: "from-emerald-500 to-yellow-500" },
