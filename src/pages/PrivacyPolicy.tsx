  ...
  return (
    <div className="min-h-screen bg-[#0f0f23] text-white">
      <div className="max-w-2xl mx-auto px-6 py-8">
        <Link to="/" className="inline-flex items-center gap-2 text-white/60 hover:text-white mb-8" data-testid="link-back-home">
        ...
        <div className="space-y-6 text-white/70 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">3. Information Sharing</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">4. Data Security</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">6. Cookies and Tracking</h2>
