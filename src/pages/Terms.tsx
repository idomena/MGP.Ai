  ...
  return (
    <div className="min-h-screen bg-[#0f0f23] text-white">
      <div className="max-w-2xl mx-auto px-6 py-8">
        <Link to="/" className="inline-flex items-center gap-2 text-white/60 hover:text-white mb-8" data-testid="link-back-home-terms">
          <ArrowLeft className="w-4 h-4" />
          <span className="text-sm">Back</span>
        </Link>

        <h1 className="text-2xl font-bold mb-2" data-testid="text-terms-title">Terms of Service</h1>
        <p className="text-white/40 text-sm mb-8">Last updated: February 6, 2026</p>
        ...
        <div className="space-y-6 text-white/70 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">4. Health Disclaimer</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">5. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-white font-semibold text-base mb-2">6. User Conduct</h2>
